...
<script type="text/javascript">
    jQuery(document).ready(function() {
        jQuery("#AccessRightCategoryAddForm").validationEngine();
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-10">
                            <h1 class="mainTitle">Add New Role</h1>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="container-fluid container-fullw bg-white">
                    <?php
                    echo $this->Form->create($model, array('url' => array('plugin' => 'access_right_category', 'controller' => 'access_right_categories', 'action' => 'add'), 'enctype' => 'multipart/form-data'));
                    ?>
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <tr>
                                            <td><a href="javascript:void(0);" class='clicklink'  title='partner'>System Masters</a>
                                                <span style='float:right'>
                                                    <?php echo $this->Form->checkbox($model . '.checkmasters', array('class' => 'checkmasters pcheckbox', 'title' => 'System Masters', 'legend' => false, 'label' => false, 'hiddenField' => false)); ?>
