...
class PaypalComponent extends Object 
{
	...
	$customsettings = array(
		...
		$this_script 	= Router::url(array('plugin'=>'quotation','controller'=>'quotations','action'=>'paypal_response'),true);
		$paypal_success = Router::url(array('plugin'=>'quotation','controller'=>'quotations','action'=>'paypal_response'),true);
		$paypal_cancle 	= Router::url(array('plugin'=>'quotation','controller'=>'quotations','action'=>'paypal_response'),true);
		...
		$p->add_field('username','kargo Quotation');//$_POST['paypalemail']
		...
		$p->add_field('item_name', 'Quotation');
