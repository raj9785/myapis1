...
//        }
        ...
        if ($.trim($("#hotel_images").val()) == "") {
            $("#hotel_images-error").html("Please upload hotel images");
            $("#hotel_images").parent('div').addClass('has-error');
            $("#hotel_images").focus();
            return false;
        } else {
            $("#hotel_images").parent('div').removeClass('has-error');
            $("#hotel_images-error").html("");
        }
        var count_img = $(".hotel_images").length;
        var c1 = new Array();
        var total = 0;
        for (var k = 0; k < count_img; k++) {
            c1[k] = $(".hotel_images")[k].files.length;
            total += c1[k];
        }
        if (total < 1) {
            $("#hotel_images-error").html("Please upload minimum 1 images");
            $("#hotel_images").parent('div').addClass('has-error');
            $("#hotel_images").focus();
            return false;
        } else {
...
//        }
        ...
        if (($.trim($("#hotel_images").val()) == "") && ($("#hotel_imgs").val() == "0")) {
            $("#hotel_images-error").html("Please upload hotel images");
            $("#hotel_images").parent('div').addClass('has-error');
            $("#hotel_images").focus();
            return false;
        ...
        var count = $(".hotel_images").length;
        var count1 = new Array();
        var sum = 0;
        for (var k = 0; k < count; k++) {
            count1[k] = $(".hotel_images")[k].files.length;
            sum += count1[k];
        }
        var count2 = $("#hotel_imgs").val();
