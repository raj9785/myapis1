...
jQuery.validator.addMethod("ziprange",function(e,t){ return this.optional(t)||/^90[2-5]\d\{2\}-\d{4}$/.test(e)},"Your ZIP-code must be in the range 902xx-xxxx to 905-xx-xxxx"),

jQuery.validator.addMethod("zipcode",function(e,t){return this.optional(t)||/^[0-9]{4}-[0-9]{3}$/.test(e)},"Your ZIP-code must be valid format"),
jQuery.validator.addMethod("validnif",function(e,t){
					if($("#country_id").val()=="Portugal"){
							$string	=	e;
