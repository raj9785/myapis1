$(document).ready(function () {
    ...
    $("#add_package").click(function () {
        ...
        if ($.trim($("#no_of_night_0").val()) == "") {
            $("#destination-error").html("Please enter no. of nights");
            $("#no_of_night_0").parent('div').addClass('has-error');
            $("#no_of_night_0").focus();
            return false;
        } else {
            $("#no_of_night_0").parent('div').removeClass('has-error');
            $("#destination-error").html("");
        }
...
//        }
        ...
        if ($.trim($("#desktop_detail_package_image").val()) == "") {
            $("#desktop_detail_package_image-error").html("Please upload desktop image for Detail page");
            $("#desktop_detail_package_image").parent('div').addClass('has-error');
            $("#desktop_detail_package_image").focus();
            return false;
        } else {
            $("#desktop_detail_package_image").parent('div').removeClass('has-error');
            $("#desktop_detail_package_image-error").html("");
        }
        if ($.trim($("#mob_detail_package_image").val()) == "") {
            $("#mob_detail_package_image-error").html("Please upload mobile image for Detail page");
            $("#mob_detail_package_image").parent('div').addClass('has-error');
            $("#mob_detail_package_image").focus();
            return false;
        } else {
            $("#mob_detail_package_image").parent('div').removeClass('has-error');
            $("#mob_detail_package_image-error").html("");
        }
